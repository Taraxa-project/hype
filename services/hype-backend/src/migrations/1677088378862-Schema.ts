...
export class Schema1677088378862 implements MigrationInterface {
  name = 'Schema1677088378862';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "hype_reward" ("id" SERIAL NOT NULL, "poolId" integer NOT NULL, "amount" character varying NOT NULL, "rewardee" character varying NOT NULL, "tokenAddress" character varying NOT NULL, "claimed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_6a1502d10e0da9d2cbef3017ebf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
