        ...
        <Box display="flex" flexDirection="column" gridGap="1rem">
          ...
          <Box display="flex" flexDirection="column">
            ...
            <Text>
              ...
              indexing. If it is not, you can submit the group’s ID to Hype and it’ll be included in
              the next cycle.
            </Text>
            <ButtonsContainer>
              <TelegramListButton />
          ...
          <Box display="flex" flexDirection="column">
            ...
            <Text>
              Hype’s analytics & machine-learning algorithms automatically indexes thousands of
              ...
              message’s impact in terms of impressions - i.e., how many users have likely seen the
              message, and rewards are assigned as defined by each Hype pool.
            </Text>
            <Text>
              If you’re familiar with data analytics and machine-learning, you can read more about
