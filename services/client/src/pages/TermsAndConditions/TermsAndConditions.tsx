...
export const TC = () => {
  return (
    ...
    >
      ...
      <ul>
        <li><Text><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Hype</Text></li>
        <li><Text><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</Text></li>
        <li><Text><strong>Country</strong> refers to: Romania</Text></li>
        <li><Text><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <strong>OFF-CHAIN SOFTWARE DEVELOPMENT S.R.L.</strong>, a Romanian company</Text></li>
        <li><Text><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</Text></li>
        <li><Text><strong>Service</strong> refers to the Application.</Text></li>
        <li><Text><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.</Text></li>
        <li><Text><strong>Third - party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third - party that may be displayed, included or made available by the Service.</Text></li>
        <li><Text><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</Text></li>
      </ul>

      <Subtitle>Acknowledgment</Subtitle>
      ...
      <Text>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the <a href="/privacy-policy">Privacy Policy</a> of the Company. Our <a href="/privacy-policy">Privacy Policy</a> describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our <a href="/privacy-policy">Privacy Policy</a> carefully before using Our Service.</Text>
      ...
      <Text>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</Text>
      ...
      <Subtitle>For European Union (EU) Users</Subtitle>
      ...
      <Subtitle>United States Legal Compliance</Subtitle>
      ...
      <Subtitle>Translation Interpretation</Subtitle>
      <Text>These Terms and Conditions may have been translated if We have made them available to You on our Service.</Text>
      <Text>You agree that the original English text shall prevail in the case of a dispute.</Text>

      <Subtitle>Changes to These Terms and Conditions</Subtitle>
      ...
      <Text>If you have any questions about these Terms and Conditions, You can contact us by email: <strong>contact@gethyped.app</strong></Text>
    </Box>
  );
};
