...
MobileDisconnected.args = { variant: "mobile", headerElements: [HeaderValues.HypeFarming, HeaderValues.HypePool, HeaderValues.Redeem], status: "notConnected", onConnect: () => {}};
...
DesktopDisconnected.args = { variant: "desktop", headerElements: [HeaderValues.HypeFarming, HeaderValues.HypePool, HeaderValues.Redeem], status: "notConnected", onConnect: () => {}};
